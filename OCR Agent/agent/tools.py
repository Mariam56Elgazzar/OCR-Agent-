...
# from langchain_ollama import ChatOllama # <-- Original line
...
# --- Model Selection Replacement ---
# Replace ChatOllama with ChatGroq and a vision-capable Groq model
# 'meta-llama/llama-4-scout-17b-16e-instruct' is a Groq model that supports vision.
...
def extract_text(img_path: str) -> str:
    ...
    try:
        ...
        # Note: The 'image_url' URL format is correct for passing base64 to vision models
        # in LangChain, including those using the OpenAI API spec (which Groq supports).
        message = [
            HumanMessage(
                content=[
                    {
